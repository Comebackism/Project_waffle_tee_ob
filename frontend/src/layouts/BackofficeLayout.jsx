...
import { FaHome, FaConciergeBell, FaBoxes, FaChartBar, FaUserShield, FaUsers, FaBars, FaList, FaSignOutAlt, FaQrcode, FaUtensils } from 'react-icons/fa';
  ...
  const getNavItems = () => {
    ...
    if (currentRole === 'admin') {
      return [
        ...
        { path: '/kitchen', label: 'ห้องครัว', icon: <FaUtensils /> },
